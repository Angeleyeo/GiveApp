...
public class iCU_uncompleted_accept_reject extends AppCompatActivity {

    private static final String TAG = "iCU_uncompleted_accept_";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i_c_u_uncompleted_accept_reject);
    ...
    public void showDetailPopUp(View v) {
        myDialog = new Dialog(iCU_uncompleted_accept_reject.this);
        myDialog.setContentView(R.layout.i_c_u_uncompleted_detail_popup);

        Button acceptChallengeBtn = myDialog.findViewById(R.id.acceptChallengeBtn);
        Button rejectChallengeBtn = myDialog.findViewById(R.id.rejectChallengeBtn);

        acceptChallengeBtn.setEnabled(true);

        acceptChallengeBtn.setOnClickListener(new View.OnClickListener() {  // admin!! so there will be collection (friends, rvd, sent all need) for new users le
            @Override
            public void onClick(View v) {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                rcvdChallenge.setStatus("Accepted");
                                ...
                                Toast.makeText(iCU_uncompleted_accept_reject.this, "Challenge Accepted", Toast.LENGTH_LONG).show();
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                PassChallenges sentChallenge = new PassChallenges(currentUserId, challengeId, friendName, challengeName, "Accepted");
                ...
                Intent i = new Intent(iCU_uncompleted_accept_reject.this, iCU_main.class);
                i.putExtra("acceptedChallenge", rcvdChallenge);
                startActivity(i);
                finish();
        ...
        rejectChallengeBtn.setOnClickListener(new View.OnClickListener() {  // admin!! so there will be collection (friends, rvd, sent all need) for new users le
            @Override
            public void onClick(View v) {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                rcvdChallenge.setStatus("Rejected");
                                ...
                                Toast.makeText(iCU_uncompleted_accept_reject.this, "Challenge Rejected", Toast.LENGTH_LONG).show();
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                // in other user's "sentChallenges", update the challenge status of the challenge submitted
                                PassChallenges sentChallenge = new PassChallenges(currentUserId, challengeId, friendName, challengeName, "Rejected");
                ...
                Intent i = new Intent(iCU_uncompleted_accept_reject.this, iCU_uncompleted.class);
                i.putExtra("acceptedChallenge", rcvdChallenge);
                startActivity(i);
                finish();
